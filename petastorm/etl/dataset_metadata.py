...
def get_schema_from_dataset_url(dataset_url_or_urls, hdfs_driver='libhdfs3', s3_configuration=None):
    ...
    :return: A :class:`petastorm.unischema.Unischema` object
    """
    fs, path_or_paths = get_filesystem_and_path_or_paths(dataset_url_or_urls, hdfs_driver, s3_configuration)
